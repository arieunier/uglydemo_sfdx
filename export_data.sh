...
sfdx force:data:tree:export --query "select Name, Mineral_Deposit__c, externalid__c from Mine__c" --prefix sfdx-demo-data --outputdir ./data --plan  -u $SCRATCHORGALIAS